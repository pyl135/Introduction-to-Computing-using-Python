...
art1 = Artist("Taylor Swift","Big Machine Records, LLC")
art2 = Artist("LIGHTS","Warner Bros. Records Inc.")
song_1 = Song("You Belong With Me", "Fearless", 2008, art1)
song_2 = Song("All Too Well","Red", 2012, art1)
song_3 = Song("Up We Go", "Midnight Machines", 2016, art2)
